...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_WelcomeDialog_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_WelcomeDialog_t qt_meta_stringdata_WelcomeDialog = {
    {
        QT_MOC_LITERAL(0, 13),  // "WelcomeDialog"
        QT_MOC_LITERAL(14, 13),  // "valueProgress"
        QT_MOC_LITERAL(28, 0)   // ""
    },
    "WelcomeDialog",
    "valueProgress",
...
const QMetaObject WelcomeDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_WelcomeDialog.offsetsAndSizes,
    qt_meta_data_WelcomeDialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_WelcomeDialog_t
